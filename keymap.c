...
const uint16_t PROGMEM combtab[] = {LT(2,KC_ESC), KC_SPC, COMBO_END};
const uint16_t PROGMEM combdel[] = {KC_ENT, LT(3,KC_BSPC), COMBO_END};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_QWERTY] = LAYOUT(
		...
		KC_Z,       KC_X,    KC_C,    KC_V, KC_B,    KC_N,    KC_M, KC_COMM,  KC_DOT, KC_SLSH,
                            LT(2,KC_ESC), KC_SPC,    KC_ENT, LT(3,KC_BSPC)),
	 ...
	 * │   1  │   2  │   3  │   4  │   5  │   6  │   7  │   8  │   9  │   0  │
	 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
	 * │ TG 4 │ Alt  │ Ctrl │ Shft │      │ Left │ Down │  Up  │ Right│   ;  │
	 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
	 * │      │  {   │  [   │  (   │      │      │  )   │  ]   │  }   │  :   │
	 * ├──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┼──────┤
	 * │      │      │      │      │ SPC  │ENTER │ BSPC │      │      │      │   
	...
	[_LOWER] = LAYOUT(
		...
		TG(4),   OSM_ALT, OSM_CTL, OSM_SFT, _______,     KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_SCLN, 
	...
	[_ADJUST] = LAYOUT(
		...
		TG(4),   KC_LEFT, KC_DOWN, KC_RGHT, KC_PGDN,      KC_WH_D, KC_MS_L, KC_MS_D, KC_MS_R, _______,
